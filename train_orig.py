...
SNAPSHOT_DIR = 'C:/Users/yonghyun/Desktop/smp_building/weight/original_building_DeeplabV3p_res101_resize512_AdamW' # 저장 경로
"""------------------------ function parameters ---------------------------"""
...
#     f = open(args.data_dir + args.csv_data, 'r')
    ...
    trainloader = data.DataLoader(
        LoadOrigBuilding(args.data_dir, args.img_folder_name, image_list_imgs, args.label_folder_name, 
                        mean=IMG_MEAN,
